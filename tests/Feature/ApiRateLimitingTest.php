...
class ApiRateLimitingTest extends TestCase
{
    ...
    /** @test */
    public function enforcesRateLimitsOnLoginEndpoint()
    {
    ...
    /** @test */
    public function enforcesRateLimitsOnAuthenticatedEndpoints()
    {
    ...
    /** @test */
    public function enforcesStricterRateLimitsOnFileDeletion()
    {
