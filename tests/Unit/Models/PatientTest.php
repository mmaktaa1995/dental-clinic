...
class PatientTest extends TestCase
{
    ...
    /** @test */
    public function hasManyMedications()
    {
        $patient = Patient::factory()->create();
    ...
    /** @test */
    public function hasManyAffectedTeethThroughPatientRecords()
    {
        $patient = Patient::factory()->create();
    ...
    /** @test */
    public function hasSymptomsThroughRecords()
    {
        $patient = Patient::factory()->create();
    ...
    /** @test */
    public function hasDiagnosisThroughRecords()
    {
        $patient = Patient::factory()->create();
    ...
    /** @test */
    public function softDeletesAndMovesToDeletedPatients()
    {
