...
class PaymentTest extends TestCase
{
    ...
    /** @test */
    public function it_belongs_to_a_visit()
    {
    ...
    /** @test */
    public function it_belongs_to_many_services()
    {
        $patient = Patient::factory()->create(['user_id' => $this->user->id]);
        $visit = Visit::factory()->create([
            'patient_id' => $patient->id,
    ...
    /** @test */
    public function it_has_many_service_payments()
    {
        $patient = Patient::factory()->create(['user_id' => $this->user->id]);
        $visit = Visit::factory()->create([
            'patient_id' => $patient->id,
    ...
    /** @test */
    public function it_formats_date_attribute()
    {
        $patient = Patient::factory()->create(['user_id' => $this->user->id]);
        $visit = Visit::factory()->create([
            'patient_id' => $patient->id,
