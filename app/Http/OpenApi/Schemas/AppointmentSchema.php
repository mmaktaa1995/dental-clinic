 ...
 *     @OA\Property(property="description", type="string", nullable=true, example="Regular dental checkup and cleaning"),
 ...
 *     @OA\Property(property="status", type="string", enum={"scheduled", "completed", "cancelled", "no_show"}, example="scheduled"),
