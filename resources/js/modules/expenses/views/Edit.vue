<template>
    <c-container>
        ...
        <div class="grid grid-cols-2 gap-6">
            ...
            <CTextField v-model="expenseDetailsStore.entry.description" :label="$t('expenses.description')" type="text" :errors="expenseDetailsStore.errors" name="description"></CTextField>
