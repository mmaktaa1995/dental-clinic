                ...
                <div class="bg-white px-4 pt-5 sm:p-6">
                    <div class="grid grid-cols-2 gap-6">
                        <div>
                            ...
                            <small v-if="errors.patient_id" class="text-rose-600 text-xs text-right block">{{ errors.patient_id[0] }}</small>
                        </div>
                        <div>
                            ...
                            <small v-if="errors.date" class="text-rose-600 text-xs text-right block">{{ errors.date[0] }}</small>
                        </div>
                        <div>
                            ...
                            <small v-if="errors.amount" class="text-rose-600 text-xs text-right block">{{ errors.amount[0] }}</small>
                        </div>
                        <div class="col-span-full">
                            ...
                            <small v-if="errors.notes" class="text-rose-600 text-xs text-right block">{{ errors.notes[0] }}</small>
                        </div>
                    </div>
                </div>
