                        ...
                        <tr v-for="payment in data" :key="payment.id">
                            ...
                            <td class="px-3 py-3 whitespace-no-wrap border-b border-gray-200 leading-5 text-gray-500">
                                ...
                                <a
                                    ...
                                    href="#"
                                    class="py-1 inline-flex h-12 px-2 text-sm text-center text-cyan-700 transition-colors duration-200 transform lg:h-8 hover:text-cyan-800 focus:outline-none"
                    ...
                    <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                        <div class="sm:flex sm:items-start">
                            ...
                            <div class="mt-3 text-center sm:mt-0 sm:mr-4 sm:text-right">
                                <h3 id="modal-title" class="text-lg leading-6 font-medium text-gray-700">حذف دفعة</h3>
                                <div class="mt-2">
...
export default {
    ...
    methods: {
        ...
        addPayment() {
            this.submitted = true
            const data = { ...this.form, patient_id: this.id }
