                        ...
                        <div class="flex-auto p-4">
                            <div class="flex flex-wrap">
                                <div class="relative w-full pr-4 max-w-full flex-grow flex-1">
                                    ...
                                    <span class="font-semibold text-xl text-rose-600 mt-3">-{{ +expensesTotal }}</span>
                                </div>
                                <div class="relative w-auto pl-4 flex-initial">
                        ...
                        <div class="flex-auto p-4">
                            <div class="flex flex-wrap">
                                <div class="relative w-full pr-4 max-w-full flex-grow flex-1">
                                    ...
                                    <span class="font-semibold text-xl mt-3" :class="{ 'text-green-600': Math.sign(incomeTotal - expensesTotal) === 1, 'text-rose-600': Math.sign(incomeTotal - expensesTotal) === -1 }">{{ incomeTotal - expensesTotal }}</span>
                                </div>
                                <div class="relative w-auto pl-4 flex-initial">
