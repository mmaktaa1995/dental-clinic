                ...
                <div class="bg-white px-4 pt-5 sm:p-6">
                    <div class="grid grid-cols-2 gap-6">
                        ...
                        <div class="">
                            ...
                            <small v-if="errors && errors.amount" class="text-pink-600 text-xs text-right block">{{ errors.amount[0] }}</small>
                        </div>
                        ...
                        <div class="">
                            ...
                            <small v-if="errors && errors.remaining_amount" class="text-pink-600 text-xs text-right block">{{ errors.remaining_amount[0] }}</small>
                        </div>
