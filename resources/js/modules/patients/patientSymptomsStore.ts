...
type PatientSymptomEntry = {
    id: number
    symptoms: null
    record_date: string
}
export const usePatientSymptomsStore = defineEntryListStore("patient-symptoms-store", {
    state: () => {
        return {
...
if (import.meta.hot) {
    // @ts-ignore
    import.meta.hot.accept(acceptHMRUpdate(usePatientSymptomsStore, import.meta.hot))
}
