...
import { ServiceEntry } from "@/modules/services/detailStore"

export const useServicesStore = defineEntryListStore("services-store", {
    state: () => {
        return {
            entries: null as null | ServiceEntry[],
            isLoading: true,
            pagination: {
                page: 1,
                last_page: 1,
