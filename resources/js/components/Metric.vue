            ...
            <dl>
                ...
                <dd class="mt-1 flex justify-between items-baseline md:block lg:flex">
                    <div class="flex items-baseline text-2xl leading-8 font-semibold text-indigo-600">
                        <c-icon-loader v-if="value === undefined" />
                    ...
                    <div v-if="percentage() != 0.0" class="inline-flex items-baseline px-2.5 py-0.5 rounded-full text-sm font-medium leading-5 md:mt-2 lg:mt-0" :class="percentage() > 0.0 ? `bg-${increaseColor}-100 text-${increaseColor}-800` : `bg-${decreaseColor}-100 text-${decreaseColor}-800`">
                        <c-icon-arrow-up v-if="percentage() > 0.0" class="-ml-1 mr-0.5 flex-shrink-0 self-center" :class="`text-${increaseColor}-500`" size="4" />
                        <c-icon-arrow-down v-else class="-ml-1 mr-0.5 flex-shrink-0 self-center" :class="`text-${decreaseColor}-500`" size="4" />
