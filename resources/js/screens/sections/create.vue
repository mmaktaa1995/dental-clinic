        ...
        <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div
                ...
                <div class="bg-gray-50 px-4 py-2 border-b border-gray-300">
                    <h3 class="font-bold text-lg text-gray-700">Add Section</h3>
                </div>
                <div class="bg-white px-4 pt-5 sm:p-6">
                    ...
                    <div class="grid grid-cols-6 gap-6 mb-2">
                        <div class="col-span-6 sm:col-span-3">
                            ...
                            <input type="number" id="section_no" autocomplete="title" v-model="section_no"
...
export default {
    ...
    methods: {
        ...
        create() {
            ...
            axios.post(`/api/sections`, data).then(({data}) => {
                self.back();
