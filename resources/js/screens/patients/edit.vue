        ...
        <form @submit.prevent="update()"
            ...
            <div
                ...
                <div class="bg-gray-50 px-4 py-2 border-b border-gray-300 text-right">
                    <h3 class="text-lg text-gray-700 font-normal">تعديل بيانات المريض <b class="font-bold">"{{
                            form.name
                        }}"</b></h3>
                </div>
                <div class="bg-white px-4 pt-5 sm:p-6">
                    ...
                    <div class="grid grid-cols-2 gap-6">
                        <div class="">
                            <label for="file_number" class="block text-sm font-medium text-gray-700 text-right">رقم
                                الملف</label>
                        ...
                        <div class="">
                            <label for="name" class="block text-sm font-medium text-gray-700 text-right">الاسم
                                الكامل</label>
...
export default {
    ...
    methods: {
        ...
        update() {
            ...
            this.errors = {};
            this.submitted = true;
            axios.patch(`/api/patients/${this.id}`, {...self.form}).then(({data}) => {
