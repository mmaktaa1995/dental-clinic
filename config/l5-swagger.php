...
return [
    ...
    'documentations' => [
        'v1' => [
            ...
            'proxy' => env('SWAGGER_PROXY', false), // Add this line to handle proxy settings
            'paths' => [
                ...
                */
                ...
                'exclude' => [
                    base_path('app/Http/OpenApi/Requests'),
                    base_path('app/Http/OpenApi/Schemas'),
                ],
            ],
        ],
    ],
